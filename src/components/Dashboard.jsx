            ...
            <div className="dashboard__main__body">
              ...
              <div className="dashboard__table__container">
                <table>
                    <thead>
                      <tr>
                          <th className='column__one'>Name</th>
                          <th>Creation Date</th>
                          <th>Status</th>
                          <th></th>
                      </tr>
                    ...
                    <tbody>
                        <tr>
                          <td className='column__one'>Gotham Asylum</td>
                          <td>10th Aug, 2023</td>
                          <td><button className='paused__btn'>Paused</button></td>
                          <td><TableHamburgerIcon/></td>
                        </tr>
                        <tr>
                          <td className='column__one'>Gotham Asylum</td>
                          <td>10th Aug, 2023</td>
                          <td><button>Archived</button></td>
                          <td><TableHamburgerIcon/></td>
                        </tr>
                        <tr>
                          <td className='column__one'>Gotham Asylum</td>
                ...
                <div className="pop__up__card__wrapper">
                    <div className="dropDown__box">
                        <div className="contents__wrapp">
                            <p><EyeIcon/><label htmlFor="">view Transportation</label></p>
                            <p><ArchivedIcon/><label htmlFor="">Archived Transportation</label></p>
                            <p><DeleteIcon/><label htmlFor="">Delete</label></p>
                        </div>
                    </div>
                </div>
                <div className="pagination__icon__wrapper">
                    <div className="pagination__squares">
                      <p>5</p>
                    </div>
                    <div className="pagination__squares">
                      <p>10</p>
